...
def main():
    ...
    # Coordenadas del rectángulo entorno 1
    coordenadas_entorno = [
        [3.3023023, 39.4761662],
        [3.3031313, 39.4761662],
        [3.3031313, 39.4755795],
        [3.3023023, 39.4755795],
        [3.3023023, 39.4761662]
    ]

    # Coordenadas de la posidonia entorno 1
    coordenadas_posidonia = [
        [
            [3.302763, 39.4757506],
            [3.3028, 39.4757935],
            [3.3028489, 39.4758164],
            [3.3029089, 39.4758276],
            [3.3029677, 39.4758001],
            [3.3030245, 39.4757802],
            [3.303072, 39.4757481],
            [3.3030806, 39.4756961],
            [3.3030509, 39.4756564],
            [3.3030027, 39.4756243],
            [3.3029254, 39.4756146],
            [3.3027756, 39.4757048],
            [3.302763, 39.4757506]
        ],
        [
            [3.3023907, 39.4760665],
            [3.3024373, 39.4761063],
            [3.3024856, 39.4761268],
            [3.3025505, 39.4761365],
            [3.3026079, 39.4761101],
            [3.3026562, 39.4760742],
            [3.3026853, 39.4760363],
            [3.3026878, 39.4759906],
            [3.3026537, 39.4759438],
            [3.3026121, 39.4759097],
            [3.302553, 39.4759091],
            [3.3024964, 39.4759155],
            [3.302424, 39.4759643],
            [3.3023832, 39.4760151],
            [3.3023907, 39.4760665]
        ]
    ]
    """
    # Coordenadas del rectangulo entorno 2
    coordenadas_entorno = [
    ...
    # Coordenadas de la posidonia entorno 2
    coordenadas_posidonia = [
        [
